    ...
    companion object {
        ...
        fun standardFileCaseProvider() = listOf(
            ...
            listOf(
                ...
                FileCase(it, content = "\n#foo\n\nother=bar\n\n$host=foo\nnot$host=baz\n", expected = "foo"),
                FileCase(it, content = "$host=no-op\n$host=realkey\n", expected = "realkey"),
                FileCase(it, content = "$host=realkey\n$host=no-op\n", expected = "no-op"),
        ...
        fun envVarCaseProvider() = listOf(
            ...
            listOf(
                ...
                EnvVarCase(it, "$host=no-op;$host=realkey", expected = "realkey"),
                EnvVarCase(it, "$host=realkey;$host=no-op", expected = "no-op"),
