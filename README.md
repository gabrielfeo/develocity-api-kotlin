...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-2025.4.0-blue)][14]
[![Javadoc](https://img.shields.io/badge/Javadoc-2025.4.0-orange)][7]
...
%use develocity-api-kotlin(version=2025.4.0)
```
...
```kotlin
@file:DependsOn("com.gabrielfeo:develocity-api-kotlin:2025.4.0")
```
...
```kotlin
dependencies {
  implementation("com.gabrielfeo:develocity-api-kotlin:2025.4.0")
}
```
...
[14]: https://central.sonatype.com/artifact/com.gabrielfeo/develocity-api-kotlin/2025.4.0
