...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-2026.2.0-blue)][14]
[![Javadoc](https://img.shields.io/badge/Javadoc-2026.2.0-orange)][7]
...
%use develocity-api-kotlin(version=2026.2.0)
```
...
```kotlin
@file:DependsOn("com.gabrielfeo:develocity-api-kotlin:2026.2.0")
```
...
```kotlin
dependencies {
  implementation("com.gabrielfeo:develocity-api-kotlin:2026.2.0")
}
```
...
[14]: https://central.sonatype.com/artifact/com.gabrielfeo/develocity-api-kotlin/2026.2.0
